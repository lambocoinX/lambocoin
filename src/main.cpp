...
{
	int64_t halvings = pindexPrev->nHeight / 6000;
	int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD / 365;
	nSubsidy >>= halvings;
	
	int64_t minSubsidy = nCoinAge * (0.1 * CENT) / 365;		// Reward gradually goes down to 0.1% per year
	nSubsidy = max(minSubsidy,nSubsidy);
