...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about LamboCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LamboCoin"));
